#!/usr/bin/env bun
// Подчистка картинок карт, снятых с игры (список id — excluded-cards.txt,
// общий со стоп-листом конвертера): публикация в docs/ (webp + ключи
// images.json) и сырые исходники в IMAGES_PATH.
//
